...
<html>	
	...
	<body>
		...
		<table style="width:100%; border-spacing: 20px;">
			<tr>
				<td style="width:60%;"><p style="font-size:18px; font-family: Arial; font-weight: bold;">All Products</p></td>			
			...
			<tr>
				...
				<td style="border: 3px solid; border-color: #000066; padding: 10px;">
					<ul class="categories" >
						<li><a href="Category page All.php"><button type="button" class="categoryb active">Show all</button></a></li>
