...
<html>	
	...
	<body>
		...
		<ul class="headerul">
			...
			<li class="headerli"><a class="active" href="#">Category</a></li>
		...
		<table style="width:100%; border-spacing: 20px;">
			<tr>
				<td style="width:60%;"><p style="font-size:18px; font-family: Arial; font-weight: bold;">Historical</p></td>			
			...
			<tr>
				...
				<td style="border: 3px solid; border-color: #000066; padding: 10px;">
					<ul class="categories" >
						...
						<li><a href="Category page historical.php"><button type="button" class="categoryb active">Historical</button></a></li>
						<li><a href="Category page fantasy.php"><button type="button" class="categoryb">Fantasy</button></a></li>						
					</ul>
				</td>
			</tr>			
			<tr>
