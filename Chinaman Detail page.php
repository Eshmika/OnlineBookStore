...
<?php
	if (isset($_POST['buy'])){
		...
		$sql="insert into order_details(ID,Username,Bookname,Bookprice,Quantity,Totalprice,Paymentmethod)values('','$username','CHINAMAN','2475','$quantity','','')";
...
<html>	
	...
	<body>
		...
		<div class="row">
			<div class="column1">
			<img class="img" src="images\book5.png" alt="book">
			</div>
		
			<div class="column2">
			<p class="para1"><b>Book Name</b>: CHINAMAN <br><br>
				<b>Language</b>: English<br><br>
				<b>Author </b>: Shehan Karunatilaka<br><br>
				<b>Publisher</b> : G S Dodangoda Saha Samagama<br><br>
				<b>ISBN</b> : 9780143450443<br><br>
				</p>
