...
<?php
	if (isset($_POST['buy'])){
		...
		$sql="insert into order_details(ID,Username,Bookname,Bookprice,Quantity,Totalprice,Paymentmethod)values('','$username','A PASSAGE NORTH','2695','$quantity','','')";
...
<html>	
	...
	<body>
		...
		<div class="row">
			<div class="column1">
			<img class="img" src="images\book1.jpg" alt="book">
			</div>
		
			<div class="column2">
			<p class="para1"><b>Book Name</b>: A PASSAGE NORTH <br><br>
				<b>Language</b>: English<br><br>
				<b>Author </b>: Anuk Arudpragasam<br><br>
				<b>Publisher</b> : Penguin books<br><br>
				<b>ISBN</b> : 9780670094899<br><br>
				</p>
